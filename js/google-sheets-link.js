...
(function () {
  ...
  function loadCrossPageLinker() {
    ...
    s.src = 'js/cross-page-data-link.js?v=20260818-1';
    s.async = false;
  ...
  document.addEventListener('DOMContentLoaded', function () { addSheetsButton(); startNavigationFix(); loadCrossPageLinker(); });
